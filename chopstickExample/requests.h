...
/**
 * @brief This is used by the philosopher in their request to for chopsticks, 
 * and lets the chopstick know if they are requesting a chopstick to hold, or if 
...
/**
 * @brief This is used by both chopstick and philosopher requests, and 
...
/**
 * @brief This is a request sent by the philosopher to the chopsticks, 
...
/**
 * @brief This is a request sent by the chopsticks to the dining philosophers, 
...
/*! 
 * This class creates a message that the chopsticks sends over to one of the 
 ...
 * chopsticks when they request one.  The PhilosopherRequest object is 
 * created separatley, then passed into this class and serialized.  By doing so, 
 * the data is organized in such a way that after its sent over its link to 
